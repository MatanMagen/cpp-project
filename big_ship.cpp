...
//void big_ship::init(const Ship& upperShip, const Ship& lowerShip){
//	this->upperShip = upperShip;
//	this->lowerShip = lowerShip;
//}
//void big_ship::move(GameConfig::eKeys direction)
//{
//	this->lowerShip.move(direction);
//	this->upperShip.move(direction);
//	
//}
